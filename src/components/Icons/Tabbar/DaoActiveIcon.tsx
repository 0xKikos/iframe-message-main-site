...
const DaoActiveIcon = ({ className }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <path
        d="M20.3904 10.1302L14.3404 13.1602C13.5904 13.5402 13.1104 14.3102 13.1104 15.1502V20.8702C13.1104 21.7002 13.9804 22.2302 14.7204 21.8602L20.7704 18.8302C21.5204 18.4502 22.0004 17.6802 22.0004 16.8402V11.1202C22.0004 10.2902 21.1304 9.76017 20.3904 10.1302Z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
